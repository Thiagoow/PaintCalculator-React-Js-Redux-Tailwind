...
function WallBtns() {
  return (
    <div className="flex justify-center mt-8 gap-10">
      ...
      <button className="font-semibold text-sm py-2 px-5 rounded-xl bg-blueColor text-white shadow-[1px_4px_8px_rgba(29,161,242,0.5)] hover:shadow-[1px_8px_16px_rgba(29,161,242,0.5)]">
        Próxima
      </button>
    </div>
  );
